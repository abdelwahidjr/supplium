...
- "docker rebuild images"                        "$c && $d up --build -d $containers && $msg_docker_build"
- "docker build images without cache"            "$c && $d build --no-cache $containers && $d up --build -d $containers && $msg_docker_build"
