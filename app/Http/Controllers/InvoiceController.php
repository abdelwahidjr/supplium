...
class InvoiceController extends Controller
{
    ...
    public function pay(PayInvoiceRequest $request)
    {
        ...
        if ($request->amount <= $invoice->remaining_amount)
        {
            ...
            $status = 'success';
            $msg    = 'Payment process successfully completed , the total invoice paid amount : ' . $invoice->paid_amount
                . ' and total invocie remaining amount : ' . $invoice->remaining_amount . ' .';
        } else
        {
            $status = 'failed';
            $msg    = 'The payment process failed because the entered amount ' . $request->amount . ' is greater than remaining amount '
