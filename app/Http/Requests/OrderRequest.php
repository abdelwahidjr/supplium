    ...
    public function rules()
    {
        ...
        if ($type == "normal") {
            ...
            return [
                ...
                //type attribute to check if order is normal or standing
                'type' => 'required|in:' . implode(',', $this->types),
                'standing_order_name' => 'required|string|max:255',
                'standing_order_status' => 'required|string|in:' . implode(',', $this->standing_order_status),
                'standing_order_repeated_days' => 'required|array',
                'standing_order_repeated_days.*' => 'required|string|max:255|in:' . implode(',', $this->repeat_days),
                'standing_order_repeated_period' => 'required|string|max:255|in:' . implode(',', $this->repeated_period),
                'standing_order_start_date' => 'required|date_format:"Y-m-d"|after:' . date("Y-m-d"),
                'standing_order_end_date' => 'required|date_format:"Y-m-d"|after:' . date("Y-m-d"),
            ];
        }
