...
@section('content')
    ...
    <div id="mymodel" class="sweet-alert  hidden " tabindex="-1" data-custom-class="" data-has-cancel-button="false" data-has-confirm-button="true" data-allow-outside-click="false" data-has-done-function="false" data-animation="pop" data-timer="null" style="display: block; margin-top: -181px;"><div class="sa-icon sa-error" style="display: none;">
      <span class="sa-x-mark">
        ...
        </div><div class="sa-icon sa-custom" style="display: none;"></div><h4 style="margin-top: 10px" id="popup-message"></h4>
    ...
    <div id="danger-model" class="sweet-alert  hidden" tabindex="-1" data-custom-class="" data-has-cancel-button="false" data-has-confirm-button="true" data-allow-outside-click="false" data-has-done-function="false" data-animation="pop" data-timer="null" style="display: block; margin-top: -181px;"><div class="sa-icon sa-error animateErrorIcon" style="display: block;">
      <span class="sa-x-mark animateXMark">
        ...
        <span class="sa-line sa-right"></span>
            ...
            <div class="sa-placeholder"></div>
            <div class="sa-fix"></div>
        </div><div class="sa-icon sa-custom" style="display: none;"></div><h2 style="margin-top: 15px;" id="danger-msg"></h2>
        <div class="form-group">
        ...
        <span class="glyphicon glyphicon-exclamation-sign"></span> <span class="sa-help-text">Not valid</span>
            ...
            <button class="cancel btn btn-lg btn-default" tabindex="2" style="display: none;">Cancel</button>
            <div class="sa-confirm-button-container">
                <button id="hide-btn" class="confirm btn btn-lg btn-danger" tabindex="1" style="display: inline-block;">OK</button><div class="la-ball-fall">
                    <div></div>
                    <div></div>
                    <div></div>
                </div>
                        ...
                        <div class="card-body">
                            <form id="model-form" onsubmit="return false;">
                                <div class="form-group">
                                    ...
                                    <input id="order-notes" type="text" class="form-control" placeholder="Enter Notes" required/>
                                </div>
                                <div class="form-group">
                                    <label class="redial-font-weight-600">Tax</label>
                                    <input id="order-tax" type="number" class="form-control" value="0" placeholder="Order tax" required/>
                                </div>
                                ...
                                <div class="progress mb-3 redial-bg-secondry">
                                    <div id="progress-id" class="progress-bar progress-bar-striped active redial-bg-primary" role="progressbar" style="width: 0px;margin-top: 5px;" aria-valuenow="100" aria-valuemin="0" aria-valuemax="100"></div>
                                </div>
                            </form>
                        </div>
                    </div>
