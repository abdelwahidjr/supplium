            ...
            <div class="row">
                <div class="col-12 col-lg-3 col-xl-2 align-self-center">
                    ...
                    <div class="navbar-header">
                        <button type="button" style="margin-top: 5px" id="sidebarCollapse"
                                class="navbar-btn bg-transparent float-right center-block">
                ...
                <div class="col-12 col-lg-3 align-self-center d-none d-lg-inline-block">
                    <form>
                        <div class="form-group mb-0 redial-relative">
                            <input type="text" class="form-control redial-rounded-circle-50 border-0"
                                   placeholder="Search"/>
                    ...
                    <nav class="navbar navbar-expand-lg p-0">
                        <ul class="navbar-nav notification ml-auto d-inline-flex">
                            <li class="nav-item">
                                ...
                                <div class="input-group" style="margin-top: 15px;margin-right: 30px;">
                                    <button class="btn btn-success"><i class="icofont icofont-shopping-cart"></i>
                                        Checkout
                                    </button>
                                    <span
                            ...
                            <li class="nav-item dropdown  align-self-center">
                                <a class="nav-link p-3" data-toggle="dropdown" aria-expanded="false"><span
                                            class="lnr lnr-envelope h4 text-white"></span>
                            ...
                            <li class="nav-item dropdown  align-self-center">
                                <a class="nav-link p-3" data-toggle="dropdown" aria-expanded="false"><span
                                            class="lnr lnr-alarm h4 text-white"></span>
                                    <span class="ring-point">
                                            <span class="ring"></span>
                                        </span>
                                </a>
                            ...
                            <li class="nav-item dropdown user-profile align-self-center">
                                ...
                                <ul class="dropdown-menu border-bottom-0 rounded-0 py-0">
                                    <li><a class="dropdown-item py-2" href="#"><i class="fa fa-user pr-2"></i> User
                                            Profile</a></li>
                                    <li><a class="dropdown-item py-2" href="{{route('user.settings')}}"><i
                                                    class="fa fa-cog pr-2"></i> Setting</a></li>
                                    <li><a class="dropdown-item py-2" href="{{ route('logout') }}" onclick="event.preventDefault();
                                        document.getElementById('logout-form').submit();"><i
                                                    class="fa fa-sign-out pr-2"></i> {{ __('Logout') }}
                ...
                <ul class="metismenu list-unstyled mb-0" id="menu">
                    ...
                    <li>
                        <a class="has-arrow" href="#" data-toggle="collapse" aria-expanded="false"><i
                                    class="icofont icofont-shopping-cart pr-1"></i> Orders</a>
                        <ul class="collapse list-unstyled">
                            ...
                            <li><a href="{{route('order.place')}}">Place Order</a></li>
                        </ul>
                    </li>
                    <li>
                        <a href="{{route('cogs')}}"><i
                    ...
                    <li>
                        <a href="{{route('company.invoices')}}"><i
                                    class="icofont icofont-money-bag pr-1"></i> Bills </a>
                    </li>
                    ...
                    <li>
                        <a href="{{route('supplier_directory.create')}}"><i
                                    class="icofont icofont-user pr-1"></i> Supplier Directory </a>
                    </li>
